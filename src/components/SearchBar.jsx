  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 py-8 max-w-xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-3xl md:text-4xl font-semibold text-gray-800 dark:text-gray-100 transition-colors">
          WEATHER APP
        </h1>
      </div>
      ...
      <div className="flex flex-col md:flex-row w-full gap-3">
        <div className="relative flex-1">
          <input
            ...
            className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm 
                       focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent
                       placeholder-gray-500 dark:placeholder-gray-400 text-gray-800 dark:text-white font-medium transition-all"
          />
            ...
            >
              {suggestions.map((suggestion, index) => (
                <li
                  ...
                  className="px-4 py-3 cursor-pointer hover:bg-sky-50 dark:hover:bg-gray-700 transition-colors border-b border-gray-100 dark:border-gray-700 last:border-b-0"
                >
                  <div className="font-medium text-gray-800 dark:text-gray-200">{suggestion.name}</div>
          ...
          {isSearching && (
            <div className="absolute right-3 top-1/2 -translate-y-1/2">
              <svg className="animate-spin h-5 w-5 text-gray-400 dark:text-gray-500" viewBox="0 0 24 24">
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full md:w-auto px-6 py-3 bg-gray-900 dark:bg-sky-600 text-white rounded-lg font-medium
                     hover:bg-gray-700 dark:hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-gray-500 dark:focus:ring-sky-500
      ...
      <p className="text-xs text-gray-600 dark:text-gray-400 mt-3 text-center transition-colors">
